...
const MessageInput: React.FC = () => {
  ...
  return (
    <div className="border-t border-gray-200 bg-white p-4">
      {/* items-end: Aligns buttons to the bottom of the textarea as it grows.
        This is standard behavior (like WhatsApp/Telegram).
      */}
      <div className="flex items-end gap-3 max-w-4xl mx-auto">
        ...
        <div className="relative flex-1">
          <textarea
            ...
            rows={1}
            style={{ 
              minHeight: '48px', // Matches button height for single line alignment
              maxHeight: '150px', // Stops growing after ~6 lines
              resize: 'none'      // Disables manual drag handle
            }}
          />
          
          {/* Enhance Button - Anchored to bottom right */}
          <button
